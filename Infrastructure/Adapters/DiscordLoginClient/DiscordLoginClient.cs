...
internal class DiscordLoginClient : IDiscordAccessTokenProvider, IDiscordLookupUser
{
    private readonly HttpClient httpClient;
    private readonly JsonSerializerOptions jsonSerializerOptions;
    private readonly DiscordLoginClientOptions options;
    private readonly ILogger<DiscordLoginClient> logger;

    public DiscordLoginClient(HttpClient httpClient, IOptions<DiscordLoginClientOptions> options,
        JsonSerializerOptions jsonSerializerOptions, ILogger<DiscordLoginClient> logger)
    {
